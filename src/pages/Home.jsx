  ...
  return (
    <section className="pt-8 sm:pt-14 bg-gradient-to-b from-white to-emerald-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-8 items-start">
        <div>
          <span className="inline-flex items-center gap-1 text-xs font-semibold bg-emerald-50 text-emerald-700 rounded-full px-3 py-1">רפואה טבעית בגובה העיניים</span>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link to="/contact" className="px-4 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold">רוצה לשוחח עם יפת</Link>
            <Link to="/knowledge" className="px-4 py-2.5 rounded-xl border border-emerald-200 text-emerald-700 hover:bg-emerald-50 font-semibold">למאגר הידע</Link>
          </div>
